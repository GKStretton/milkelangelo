...
import { TOPIC_SESSION_STATUS_GET, TOPIC_SESSION_STATUS_RESP_JSON, TOPIC_SESSION_STATUS_RESP_RAW, TOPIC_STATE_REPORT_JSON, TOPIC_STREAM_STATUS_GET, TOPIC_STREAM_STATUS_RESP_JSON, TOPIC_STREAM_STATUS_RESP_RAW } from '../topics_backend/topics_backend'
...
export default function StateReport() {
	...
	return (
		<>
			...
			{tabValue <= 2 &&
				<>
				<Button variant="contained" sx={{width: "100px", margin: "5px"}} onClick={()=>{c?.publish(selectedTopic, "")}}>Request</Button>
