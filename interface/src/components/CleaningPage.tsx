...
import { TOPIC_FLUID, TOPIC_MAINTENANCE, TOPIC_SHUTDOWN, TOPIC_SLEEP, TOPIC_WAKE } from '../topics_firmware/topics_firmware';
  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li><input type="checkbox"/>
          <Button variant="contained" onClick={() => {
            c?.publish(TOPIC_FLUID, `${FluidType.FLUID_MILK},200,true`)
