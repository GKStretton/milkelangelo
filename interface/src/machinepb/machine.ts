...
export const PipetteState: MessageFns<PipetteState> = {
  encode(message: PipetteState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.spent !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PipetteState {
  ...
  fromJSON(object: any): PipetteState {
    return {
      ...
      vialHeld: isSet(object.vialHeld)
        ? globalThis.Number(object.vialHeld)
        : isSet(object.vial_held)
        ? globalThis.Number(object.vial_held)
        : 0,
      volumeTargetUl: isSet(object.volumeTargetUl)
        ? globalThis.Number(object.volumeTargetUl)
        : isSet(object.volume_target_ul)
        ? globalThis.Number(object.volume_target_ul)
        : 0,
      dispenseRequestNumber: isSet(object.dispenseRequestNumber)
        ? globalThis.Number(object.dispenseRequestNumber)
        : isSet(object.dispense_request_number)
...
export const CollectionRequest: MessageFns<CollectionRequest> = {
  encode(message: CollectionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CollectionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.requestNumber = longToNumber(reader.uint64());
            continue;
          }
          case 3: {
            if (tag !== 24) {
            ...
            message.vialNumber = longToNumber(reader.uint64());
            continue;
          }
          case 4: {
            if (tag !== 37) {
  ...
  fromJSON(object: any): CollectionRequest {
    return {
      ...
      requestNumber: isSet(object.requestNumber)
        ? globalThis.Number(object.requestNumber)
        : isSet(object.request_number)
        ? globalThis.Number(object.request_number)
        : 0,
      vialNumber: isSet(object.vialNumber)
        ? globalThis.Number(object.vialNumber)
        : isSet(object.vial_number)
        ? globalThis.Number(object.vial_number)
        : 0,
      volumeUl: isSet(object.volumeUl)
        ? globalThis.Number(object.volumeUl)
        : isSet(object.volume_ul)
        ? globalThis.Number(object.volume_ul)
        : 0,
    };
  },
...
export const MovementDetails: MessageFns<MovementDetails> = {
  encode(message: MovementDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MovementDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): MovementDetails {
    return {
      targetXUnit: isSet(object.targetXUnit)
        ? globalThis.Number(object.targetXUnit)
        : isSet(object.target_x_unit)
        ? globalThis.Number(object.target_x_unit)
        : 0,
      targetYUnit: isSet(object.targetYUnit)
        ? globalThis.Number(object.targetYUnit)
        : isSet(object.target_y_unit)
        ? globalThis.Number(object.target_y_unit)
        : 0,
      targetZIk: isSet(object.targetZIk)
        ? globalThis.Number(object.targetZIk)
        : isSet(object.target_z_ik)
        ? globalThis.Number(object.target_z_ik)
        : 0,
      targetRingDeg: isSet(object.targetRingDeg)
        ? globalThis.Number(object.targetRingDeg)
        : isSet(object.target_ring_deg)
        ? globalThis.Number(object.target_ring_deg)
        : 0,
      targetYawDeg: isSet(object.targetYawDeg)
        ? globalThis.Number(object.targetYawDeg)
        : isSet(object.target_yaw_deg)
        ? globalThis.Number(object.target_yaw_deg)
        : 0,
    };
  },
...
export const FluidRequest: MessageFns<FluidRequest> = {
  encode(message: FluidRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.openDrain !== false) {
      writer.uint32(32).bool(message.openDrain);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FluidRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): FluidRequest {
    return {
      ...
      volumeMl: isSet(object.volumeMl)
        ? globalThis.Number(object.volumeMl)
        : isSet(object.volume_ml)
        ? globalThis.Number(object.volume_ml)
        : 0,
      complete: isSet(object.complete) ? globalThis.Boolean(object.complete) : false,
      openDrain: isSet(object.openDrain)
        ? globalThis.Boolean(object.openDrain)
        : isSet(object.open_drain)
        ? globalThis.Boolean(object.open_drain)
        : false,
    };
  },
...
export const FluidDetails: MessageFns<FluidDetails> = {
  encode(message: FluidDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FluidDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): FluidDetails {
    return {
      bowlFluidLevelMl: isSet(object.bowlFluidLevelMl)
        ? globalThis.Number(object.bowlFluidLevelMl)
        : isSet(object.bowl_fluid_level_ml)
        ? globalThis.Number(object.bowl_fluid_level_ml)
        : 0,
    };
  },
...
export const StateReport: MessageFns<StateReport> = {
  encode(message: StateReport, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.lightsOn !== false) {
      writer.uint32(48).bool(message.lightsOn);
    }
    if (message.pipetteState !== undefined) {
      PipetteState.encode(message.pipetteState, writer.uint32(82).fork()).join();
    }
    if (message.collectionRequest !== undefined) {
      CollectionRequest.encode(message.collectionRequest, writer.uint32(90).fork()).join();
    }
    if (message.movementDetails !== undefined) {
      MovementDetails.encode(message.movementDetails, writer.uint32(98).fork()).join();
    }
    if (message.fluidRequest !== undefined) {
      FluidRequest.encode(message.fluidRequest, writer.uint32(106).fork()).join();
    }
    if (message.fluidDetails !== undefined) {
      FluidDetails.encode(message.fluidDetails, writer.uint32(114).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StateReport {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 2: {
            ...
            message.timestampUnixMicros = longToNumber(reader.uint64());
            continue;
          }
          case 3: {
            if (tag !== 24) {
            ...
            message.startupCounter = longToNumber(reader.uint64());
            continue;
          }
          case 4: {
            if (tag !== 32) {
          ...
          case 52: {
            ...
            message.latestDslrFileNumber = longToNumber(reader.uint64());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): StateReport {
    return {
      timestampUnixMicros: isSet(object.timestampUnixMicros)
        ? globalThis.Number(object.timestampUnixMicros)
        : isSet(object.timestamp_unix_micros)
        ? globalThis.Number(object.timestamp_unix_micros)
        : 0,
      startupCounter: isSet(object.startupCounter)
        ? globalThis.Number(object.startupCounter)
        : isSet(object.startup_counter)
        ? globalThis.Number(object.startup_counter)
        : 0,
      mode: isSet(object.mode) ? modeFromJSON(object.mode) : 0,
      status: isSet(object.status) ? statusFromJSON(object.status) : 0,
      lightsOn: isSet(object.lightsOn)
        ? globalThis.Boolean(object.lightsOn)
        : isSet(object.lights_on)
        ? globalThis.Boolean(object.lights_on)
        : false,
      pipetteState: isSet(object.pipetteState)
        ? PipetteState.fromJSON(object.pipetteState)
        : isSet(object.pipette_state)
        ? PipetteState.fromJSON(object.pipette_state)
        : undefined,
      collectionRequest: isSet(object.collectionRequest)
        ? CollectionRequest.fromJSON(object.collectionRequest)
        : isSet(object.collection_request)
        ? CollectionRequest.fromJSON(object.collection_request)
        : undefined,
      movementDetails: isSet(object.movementDetails)
        ? MovementDetails.fromJSON(object.movementDetails)
        : isSet(object.movement_details)
        ? MovementDetails.fromJSON(object.movement_details)
        : undefined,
      fluidRequest: isSet(object.fluidRequest)
        ? FluidRequest.fromJSON(object.fluidRequest)
        : isSet(object.fluid_request)
        ? FluidRequest.fromJSON(object.fluid_request)
        : undefined,
      fluidDetails: isSet(object.fluidDetails)
        ? FluidDetails.fromJSON(object.fluidDetails)
        : isSet(object.fluid_details)
        ? FluidDetails.fromJSON(object.fluid_details)
        : undefined,
      rinseStatus: isSet(object.rinseStatus)
        ? rinseStatusFromJSON(object.rinseStatus)
        : isSet(object.rinse_status)
        ? rinseStatusFromJSON(object.rinse_status)
        : 0,
      paused: isSet(object.paused) ? globalThis.Boolean(object.paused) : false,
      timestampReadable: isSet(object.timestampReadable)
        ? globalThis.String(object.timestampReadable)
        : isSet(object.timestamp_readable)
        ? globalThis.String(object.timestamp_readable)
        : "",
      latestDslrFileNumber: isSet(object.latestDslrFileNumber)
        ? globalThis.Number(object.latestDslrFileNumber)
        : isSet(object.latest_dslr_file_number)
  ...
  toJSON(message: StateReport): unknown {
    ...
    if (message.rinseStatus !== 0) {
      obj.rinseStatus = rinseStatusToJSON(message.rinseStatus);
    }
    if (message.paused !== false) {
...
export const StateReportList: MessageFns<StateReportList> = {
  encode(message: StateReportList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.StateReports) {
      StateReport.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StateReportList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SessionStatus: MessageFns<SessionStatus> = {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            message.productionId = longToNumber(reader.uint64());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SessionStatus {
    return {
      ...
      productionId: isSet(object.productionId)
        ? globalThis.Number(object.productionId)
        : isSet(object.production_id)
        ? globalThis.Number(object.production_id)
        : 0,
    };
  },
...
export const DispenseMetadataMap: MessageFns<DispenseMetadataMap> = {
  encode(message: DispenseMetadataMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.dispenseMetadata).forEach(([key, value]: [string, DispenseMetadata]) => {
      DispenseMetadataMap_DispenseMetadataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DispenseMetadataMap {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): DispenseMetadataMap {
    return {
      dispenseMetadata: isObject(object.dispenseMetadata)
        ? (globalThis.Object.entries(object.dispenseMetadata) as [string, any][]).reduce(
          (acc: { [key: string]: DispenseMetadata }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DispenseMetadata.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
        ...
        : isObject(object.dispense_metadata)
        ? (globalThis.Object.entries(object.dispense_metadata) as [string, any][]).reduce(
          (acc: { [key: string]: DispenseMetadata }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DispenseMetadata.fromJSON(value),
              enumerable: true,
  ...
  toJSON(message: DispenseMetadataMap): unknown {
    ...
    if (message.dispenseMetadata) {
      const entries = globalThis.Object.entries(message.dispenseMetadata) as [string, DispenseMetadata][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<DispenseMetadataMap>, I>>(object: I): DispenseMetadataMap {
    ...
    message.dispenseMetadata =
      (globalThis.Object.entries(object.dispenseMetadata ?? {}) as [string, DispenseMetadata][]).reduce(
        (acc: { [key: string]: DispenseMetadata }, [key, value]: [string, DispenseMetadata]) => {
          if (value !== undefined) {
...
export const DispenseMetadataMap_DispenseMetadataEntry: MessageFns<DispenseMetadataMap_DispenseMetadataEntry> = {
  encode(message: DispenseMetadataMap_DispenseMetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      DispenseMetadata.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DispenseMetadataMap_DispenseMetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const DispenseMetadata: MessageFns<DispenseMetadata> = {
  encode(message: DispenseMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.failedDispense !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DispenseMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.dispenseDelayMs = longToNumber(reader.uint64());
            continue;
          }
          case 3: {
            if (tag !== 24) {
            ...
            message.minDurationOverrideMs = longToNumber(reader.uint64());
            continue;
          }
          case 4: {
            if (tag !== 32) {
            ...
            message.speedMultOverride = longToNumber(reader.uint64());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DispenseMetadata {
    return {
      failedDispense: isSet(object.failedDispense)
        ? globalThis.Boolean(object.failedDispense)
        : isSet(object.failed_dispense)
        ? globalThis.Boolean(object.failed_dispense)
        : false,
      dispenseDelayMs: isSet(object.dispenseDelayMs)
        ? globalThis.Number(object.dispenseDelayMs)
        : isSet(object.dispense_delay_ms)
        ? globalThis.Number(object.dispense_delay_ms)
        : 0,
      minDurationOverrideMs: isSet(object.minDurationOverrideMs)
        ? globalThis.Number(object.minDurationOverrideMs)
        : isSet(object.min_duration_override_ms)
        ? globalThis.Number(object.min_duration_override_ms)
        : 0,
      speedMultOverride: isSet(object.speedMultOverride)
        ? globalThis.Number(object.speedMultOverride)
        : isSet(object.speed_mult_override)
        ? globalThis.Number(object.speed_mult_override)
        : 0,
    };
  },
...
export const ContentTypeStatuses: MessageFns<ContentTypeStatuses> = {
  encode(message: ContentTypeStatuses, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.contentStatuses).forEach(([key, value]: [string, ContentTypeStatus]) => {
      ContentTypeStatuses_ContentStatusesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ContentTypeStatuses {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            message.splashtextHue = longToNumber(reader.uint64());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ContentTypeStatuses {
    return {
      contentStatuses: isObject(object.contentStatuses)
        ? (globalThis.Object.entries(object.contentStatuses) as [string, any][]).reduce(
          (acc: { [key: string]: ContentTypeStatus }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: ContentTypeStatus.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
        ...
        : isObject(object.content_statuses)
        ? (globalThis.Object.entries(object.content_statuses) as [string, any][]).reduce(
          (acc: { [key: string]: ContentTypeStatus }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: ContentTypeStatus.fromJSON(value),
              enumerable: true,
      ...
      splashtextHue: isSet(object.splashtextHue)
        ? globalThis.Number(object.splashtextHue)
        : isSet(object.splashtext_hue)
        ? globalThis.Number(object.splashtext_hue)
        : 0,
    };
  },
  ...
  toJSON(message: ContentTypeStatuses): unknown {
    ...
    if (message.contentStatuses) {
      const entries = globalThis.Object.entries(message.contentStatuses) as [string, ContentTypeStatus][];
      if (entries.length > 0) {
        obj.contentStatuses = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ContentTypeStatuses>, I>>(object: I): ContentTypeStatuses {
    const message = createBaseContentTypeStatuses();
    message.contentStatuses = (globalThis.Object.entries(object.contentStatuses ?? {}) as [string, ContentTypeStatus][])
      .reduce((acc: { [key: string]: ContentTypeStatus }, [key, value]: [string, ContentTypeStatus]) => {
        if (value !== undefined) {
...
export const ContentTypeStatuses_ContentStatusesEntry: MessageFns<ContentTypeStatuses_ContentStatusesEntry> = {
  encode(message: ContentTypeStatuses_ContentStatusesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ContentTypeStatus.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ContentTypeStatuses_ContentStatusesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ContentTypeStatus: MessageFns<ContentTypeStatus> = {
  encode(message: ContentTypeStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rawTitle !== "") {
    ...
    for (const v of message.posts) {
      Post.encode(v!, writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ContentTypeStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): ContentTypeStatus {
    return {
      rawTitle: isSet(object.rawTitle)
        ? globalThis.String(object.rawTitle)
        : isSet(object.raw_title)
        ? globalThis.String(object.raw_title)
        : "",
      rawDescription: isSet(object.rawDescription)
        ? globalThis.String(object.rawDescription)
        : isSet(object.raw_description)
        ? globalThis.String(object.raw_description)
        : "",
      ...
      musicFile: isSet(object.musicFile)
        ? globalThis.String(object.musicFile)
        : isSet(object.music_file)
        ? globalThis.String(object.music_file)
        : "",
      musicName: isSet(object.musicName)
        ? globalThis.String(object.musicName)
        : isSet(object.music_name)
        ? globalThis.String(object.music_name)
        : "",
    };
  },
  ...
  toJSON(message: ContentTypeStatus): unknown {
    ...
    if (message.musicFile !== "") {
      obj.musicFile = message.musicFile;
    }
    if (message.musicName !== "") {
      obj.musicName = message.musicName;
    }
    return obj;
  },
...
export const Post: MessageFns<Post> = {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 8: {
            ...
            message.scheduledUnixTimetamp = longToNumber(reader.uint64());
            continue;
          }
          case 9: {
            if (tag !== 72) {
  ...
  fromJSON(object: any): Post {
    return {
      ...
      subPlatform: isSet(object.subPlatform)
        ? globalThis.String(object.subPlatform)
        : isSet(object.sub_platform)
        ? globalThis.String(object.sub_platform)
        : "",
      ...
      scheduledUnixTimetamp: isSet(object.scheduledUnixTimetamp)
        ? globalThis.Number(object.scheduledUnixTimetamp)
        : isSet(object.scheduled_unix_timetamp)
...
export const VialProfile: MessageFns<VialProfile> = {
  encode(message: VialProfile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.description !== "") {
    ...
    if (message.footageIgnore !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VialProfile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            message.footageDelayMs = longToNumber(reader.uint64());
            continue;
          }
          case 6: {
            if (tag !== 48) {
            ...
            message.footageMinDurationMs = longToNumber(reader.uint64());
            continue;
          }
          case 7: {
            if (tag !== 61) {
  ...
  fromJSON(object: any): VialProfile {
    return {
      id: isSet(object.id) ? globalThis.Number(object.id) : 0,
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      slopUl: isSet(object.slopUl)
        ? globalThis.Number(object.slopUl)
        : isSet(object.slop_ul)
        ? globalThis.Number(object.slop_ul)
        : 0,
      dispenseVolumeUl: isSet(object.dispenseVolumeUl)
        ? globalThis.Number(object.dispenseVolumeUl)
        : isSet(object.dispense_volume_ul)
        ? globalThis.Number(object.dispense_volume_ul)
        : 0,
      footageDelayMs: isSet(object.footageDelayMs)
        ? globalThis.Number(object.footageDelayMs)
        : isSet(object.footage_delay_ms)
        ? globalThis.Number(object.footage_delay_ms)
        : 0,
      footageMinDurationMs: isSet(object.footageMinDurationMs)
        ? globalThis.Number(object.footageMinDurationMs)
        : isSet(object.footage_min_duration_ms)
        ? globalThis.Number(object.footage_min_duration_ms)
        : 0,
      footageSpeedMult: isSet(object.footageSpeedMult)
        ? globalThis.Number(object.footageSpeedMult)
        : isSet(object.footage_speed_mult)
        ? globalThis.Number(object.footage_speed_mult)
        : 0,
      footageIgnore: isSet(object.footageIgnore)
        ? globalThis.Boolean(object.footageIgnore)
        : isSet(object.footage_ignore)
        ? globalThis.Boolean(object.footage_ignore)
        : false,
      initialVolumeUl: isSet(object.initialVolumeUl)
        ? globalThis.Number(object.initialVolumeUl)
        : isSet(object.initial_volume_ul)
        ? globalThis.Number(object.initial_volume_ul)
        : 0,
      currentVolumeUl: isSet(object.currentVolumeUl)
        ? globalThis.Number(object.currentVolumeUl)
        : isSet(object.current_volume_ul)
        ? globalThis.Number(object.current_volume_ul)
        : 0,
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      vialFluid: isSet(object.vialFluid)
        ? vialProfile_VialFluidFromJSON(object.vialFluid)
        : isSet(object.vial_fluid)
        ? vialProfile_VialFluidFromJSON(object.vial_fluid)
        : 0,
  ...
  toJSON(message: VialProfile): unknown {
    ...
    if (message.vialFluid !== 0) {
      obj.vialFluid = vialProfile_VialFluidToJSON(message.vialFluid);
    }
    if (message.colour !== "") {
...
export const SystemVialConfiguration: MessageFns<SystemVialConfiguration> = {
  encode(message: SystemVialConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.vials).forEach(([key, value]: [string, number]) => {
      SystemVialConfiguration_VialsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SystemVialConfiguration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): SystemVialConfiguration {
    return {
      vials: isObject(object.vials)
        ? (globalThis.Object.entries(object.vials) as [string, any][]).reduce(
  ...
  toJSON(message: SystemVialConfiguration): unknown {
    const obj: any = {};
    if (message.vials) {
      const entries = globalThis.Object.entries(message.vials) as [string, number][];
      if (entries.length > 0) {
        obj.vials = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<SystemVialConfiguration>, I>>(object: I): SystemVialConfiguration {
    const message = createBaseSystemVialConfiguration();
    message.vials = (globalThis.Object.entries(object.vials ?? {}) as [string, number][]).reduce(
...
export const SystemVialConfiguration_VialsEntry: MessageFns<SystemVialConfiguration_VialsEntry> = {
  encode(message: SystemVialConfiguration_VialsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SystemVialConfiguration_VialsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const VialProfileCollection: MessageFns<VialProfileCollection> = {
  encode(message: VialProfileCollection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.profiles).forEach(([key, value]: [string, VialProfile]) => {
      VialProfileCollection_ProfilesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): VialProfileCollection {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
    ...
    return {
      profiles: isObject(object.profiles)
        ? (globalThis.Object.entries(object.profiles) as [string, any][]).reduce(
          (acc: { [key: number]: VialProfile }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, globalThis.Number(key), {
              value: VialProfile.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: VialProfileCollection): unknown {
    const obj: any = {};
    if (message.profiles) {
      const entries = globalThis.Object.entries(message.profiles) as [string, VialProfile][];
      if (entries.length > 0) {
        obj.profiles = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<VialProfileCollection>, I>>(object: I): VialProfileCollection {
    const message = createBaseVialProfileCollection();
    message.profiles = (globalThis.Object.entries(object.profiles ?? {}) as [string, VialProfile][]).reduce(
      (acc: { [key: number]: VialProfile }, [key, value]: [string, VialProfile]) => {
        if (value !== undefined) {
...
export const VialProfileCollection_ProfilesEntry: MessageFns<VialProfileCollection_ProfilesEntry> = {
  encode(message: VialProfileCollection_ProfilesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
      writer.uint32(8).uint64(message.key);
    }
    if (message.value !== undefined) {
      VialProfile.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): VialProfileCollection_ProfilesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SystemVialConfigurationSnapshot: MessageFns<SystemVialConfigurationSnapshot> = {
  encode(message: SystemVialConfigurationSnapshot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.profiles).forEach(([key, value]: [string, VialProfile]) => {
      SystemVialConfigurationSnapshot_ProfilesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SystemVialConfigurationSnapshot {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SystemVialConfigurationSnapshot_ProfilesEntry: MessageFns<SystemVialConfigurationSnapshot_ProfilesEntry> =
  {
    encode(
      message: SystemVialConfigurationSnapshot_ProfilesEntry,
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): SystemVialConfigurationSnapshot_ProfilesEntry {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
      if (previousRecursionDepth >= 100) {
        throw new globalThis.Error("protobuf decode recursion limit exceeded");
