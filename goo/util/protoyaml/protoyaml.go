// https://github.com/spinnaker/kleat/blob/master/internal/protoyaml/protoyaml.go
// Note, marshalling looks very simple so it could maybe be all in this repo.
// unmarshall looks a bit reflective though
/*
